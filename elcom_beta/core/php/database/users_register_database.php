    ...
    */
    ...
    public function create() {
        ...
        */
        ...
        foreach ($table_columns_array as $table_column) {
            ...
            $table_column_value = $Users_Register_DB->mysql_prep_value($this->$table_column);
        ...
        * } - Create query - end
        */
        if($Users_Register_DB->run_query($query)) {
            $this->id = $Users_Register_DB->get_last_record_id();
        } else {
            return false;
        }
    }
    ...
    public function update() {
        ...
        */
        ...
        $Users_Register_DB->run_query($query);

        if ($Users_Register_DB->get_nof_affected_rows() == 1){
            return true;
        } else {
            return false;
        }
    ...
    public function delete() {
        ...
        */
        $query  = "DELETE FROM ";
        $query .= $current_child_table_name . " ";
        $query .= "WHERE id=" . $Users_Register_DB->mysql_prep_value($this->id) . " ";
        $query .= "LIMIT 1";
    ...
    public static function get_by_sql($sql) {
        ...
        $result = $Users_Register_DB->run_query($sql);
    ...
    public static function get_table_columns()
    {
        ...
        $result = $Users_Register_DB->run_query("SHOW COLUMNS FROM " . static::$table_name);
